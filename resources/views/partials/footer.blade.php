<div class="container-fluid p-0 position-relative" style="background-color: #30ACB0;" id="contact">
    ...
    <div class="d-lg-block d-none rounded position-absolute p-4" style="left:65%; top: 12.5%; height: 75%; width: 30%; background-color: #30ACB0; border-radius: 15px;">
        <p class="text-white font-size-16 font-weight-normal roboto">
            Стоматология DrBond рад приветствовать Вас в своей клинике. Мы открылись в октябре 2016 года, но совокупный накопленный опыт команды на текущий момент – более 100 лет.
        </p>
