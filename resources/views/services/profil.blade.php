    ...
    <div class="container" style="transform: translateY(-100px);">
        <div class="mt-5">
            <p class="font-size-16" style="color: #8C8C8C;">
                Профилактика стоматологических заболеваний - это предупреждение возникновения и развития заболеваний полости рта (не только зубов, а также десен).
            </p>
            <p class="font-size-16" style="color: #8C8C8C;">
                Активное и правильное использование профилактических процедур позволяет реже обращаться к стоматологоам,  резко снижает интенсивности кариеса зубов и болезней пародонта, значительно уменьшает случаи потери зубов в молодом.

            </p>
        </div>
        <div class="mt-3">
            <p class="font-size-16" style="color: #8C8C8C">
                <span class="font-weight-bold" style="color: #30ACB0;">ВНИМАНИЕ!</span> Помните, что важно проводить профилактические процедуры, их стоимость в среднем, в 20 раз ниже стоимости лечения уже возникших стоматологических заболеваний.
            </p>
        </div>
        ...
        <div>
            ...
            <ul class="font-size-16" style="color: #8C8C8C;">
                ...
                <li class="mb-3">
                    Профилактический прием у стоматолога (не реже 1 раз в шесть месяцев)
                </li>
            </ul>
        </div>
